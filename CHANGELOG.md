...
- Rustdoc comments on all public items for docs.rs documentation.
- CI pipeline with cargo check, test, clippy, and fmt.
- Binary release workflow for Linux and macOS (x86_64 and aarch64).

### Fixed

- Cross-platform compilation for macOS (cfg gates for Linux-only APIs).
- README links compatible with rustdoc rendering.
...
[Unreleased]: https://github.com/nandomoreirame/tumodori/compare/v0.1.1...HEAD
[0.1.1]: https://github.com/nandomoreirame/tumodori/compare/v0.1.0...v0.1.1
